...
inline void printDeviceInfos(ur_device_handle_t hDevice,
  ...
  std::cout << prefix;
  printDeviceInfo<uint32_t>(hDevice, UR_DEVICE_INFO_IGCA);
  std::cout << prefix;
  printDeviceInfo<ur_device_igca_feature_set_t>(
  ...
  std::cout << prefix;
  printDeviceInfo<ur_bool_t>(hDevice, UR_DEVICE_INFO_IPC_EVENT_SUPPORT_EXP);
  std::cout << prefix;
  printDeviceInfo<ur_bool_t>(hDevice,
