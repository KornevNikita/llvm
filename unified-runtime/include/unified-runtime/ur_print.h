...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_device_igca_feature_set_t enum
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintDeviceIgcaFeatureSet(
    enum ur_device_igca_feature_set_t value, char *buffer,
    const size_t buff_size, size_t *out_size);
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_command_buffer_append_kernel_launch_with_args_exp_params_t
/// struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL
urPrintCommandBufferAppendKernelLaunchWithArgsExpParams(
...
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintIpcGetMemHandleExpParams(
    const struct ur_ipc_get_mem_handle_exp_params_t *params, char *buffer,
    const size_t buff_size, size_t *out_size);

///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_ipc_put_mem_handle_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintIpcPutMemHandleExpParams(
    const struct ur_ipc_put_mem_handle_exp_params_t *params, char *buffer,
    const size_t buff_size, size_t *out_size);

///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_ipc_open_mem_handle_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintIpcOpenMemHandleExpParams(
    const struct ur_ipc_open_mem_handle_exp_params_t *params, char *buffer,
    const size_t buff_size, size_t *out_size);

///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_ipc_close_mem_handle_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
...
///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_ipc_get_event_handle_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintIpcGetEventHandleExpParams(
    const struct ur_ipc_get_event_handle_exp_params_t *params, char *buffer,
    const size_t buff_size, size_t *out_size);

///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_ipc_put_event_handle_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintIpcPutEventHandleExpParams(
    const struct ur_ipc_put_event_handle_exp_params_t *params, char *buffer,
    const size_t buff_size, size_t *out_size);

///////////////////////////////////////////////////////////////////////////////
/// @brief Print ur_ipc_open_event_handle_exp_params_t struct
/// @returns
///     - ::UR_RESULT_SUCCESS
///     - ::UR_RESULT_ERROR_INVALID_SIZE
///         - `buff_size < out_size`
UR_APIEXPORT ur_result_t UR_APICALL urPrintIpcOpenEventHandleExpParams(
