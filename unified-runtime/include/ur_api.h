...
typedef enum ur_device_info_t {
  ...
  /// [::ur_bool_t] returns true if the device supports sampling values from the
  /// sub-group clock.
  UR_DEVICE_INFO_CLOCK_SUB_GROUP_SUPPORT_EXP = 0x2051,
  /// [::ur_bool_t] returns true if the device supports sampling values from the
  /// work-group clock.
  UR_DEVICE_INFO_CLOCK_WORK_GROUP_SUPPORT_EXP = 0x2052,
  /// [::ur_bool_t] returns true if the device supports sampling values from the
  /// device clock.
  UR_DEVICE_INFO_CLOCK_DEVICE_SUPPORT_EXP = 0x2053,
